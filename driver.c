...
int main(int argc, char* argv[]) {
    ...
    printf("================================================================================\n");
    printf("                        HPL-AI Mixed-Precision Benchmark                        \n");
    printf("       Written by Yaohung Mike Tsai, Innovative Computing Laboratory, UTK       \n");
    printf("================================================================================\n");
    printf("\n");
    printf("This is a reference implementation with the matrix generator, an example\n");
    printf("mixed-precision solver with LU factorization in single and GMRES in double,\n");
    ...
    printf("||Ax-b||_oo / ( eps * ( || x ||_oo * || A ||_oo + || b ||_oo ) * N )\n");
